...
class BotConfig:
    ...
    response_willing_amplifier: float = 1.3  # 回复意愿放大系数
    response_interested_rate_amplifier: float = 1.3  # 回复兴趣度放大系数
    ...
    MODEL_R1_PROBABILITY: float = 0.6  # R1模型概率
    MODEL_V3_PROBABILITY: float = 0.3  # V3模型概率
